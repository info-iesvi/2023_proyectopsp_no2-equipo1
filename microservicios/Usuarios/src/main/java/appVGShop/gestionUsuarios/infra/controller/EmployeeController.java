...
public class EmployeeController implements EmployeeAPI {
    ...
    public ResponseEntity<?> newUser(@RequestBody EmployeeDTOCreator newUserCreator) {
        ...
        try {
            ...
            if (resourcekey == null) {
                ...
                //Generamos una clave secreta para poder encriptar y desencriptar el fichero accesos.log
                //generateSecretKey();

                //Encriptamos el fichero accesos.log usando la clave secreta
                encryptSymmetricFile();

                //Desencriptamos el fichero accesos.log usando la clave secreta
                descryptSymmetricFile();

                //Firmamos el fichero accesos.log usando la clave privada y comprobamos la firma con la clave pública
                generateSignFile();
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public ResponseEntity<?> editUser(EmployeeDTOCreator editData, Integer id) {
        //Generamos un nuevo registro en el fichero accesos.log cada vez que se actualiza un usuario
    ...
    public void generateAccessLog(String user, String resource, String operation) {
        ...
        //Comprobamos el fichero accesos.log y si no existe lo creamos
        try {
